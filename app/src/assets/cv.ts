...
export const experience: Experience[] = [
	...
	},
	{
		...
		description:
			'Senior Researcher with Public Health Wales to produce a report on the impact of COVID-19 on the homeless population in Wales.',
		link: undefined,
		image: undefined,
	...
	},
	{
		...
		description:
			'Report on the user experience of wellbeing apps as reported by users on the Google and Apple app stores for Bounce Technologies ltd.',
		link: undefined,
		image: undefined,
		disciplines: [],
	},
	...
	},
	{
		...
		title: 'PhD Thesis',
		description:
			'Title: Visual and gamified approaches to understanding cmplx causal networks in human health',
		link: undefined,
		image: undefined,
	...
	},
	{
		...
		title: 'MSc',
		description:
			'Graduated MSc Research Methods in Experimental Psychology from the University of Bristol.',
		link: undefined,
		image: undefined,
		disciplines: [d.cmplx],
	},
	{
		...
		title: 'Market research',
		description:
			'Gap analysis judging whether there is need in the market for a new self-guided tour application for Totum Insight ltd.',
		link: undefined,
		image: undefined,
		disciplines: [],
	},
	...
	},
	{
		...
		description:
			'A website commissioned as the first point of contact for primary care patients. A beskpoke advice directory helped relieve burden on the practice by providing online advice on acute conditions, freeing up phone lines for more urgent calls. ',
		link: undefined,
	...
	},
	{
		...
		title: 'BSc',
		description:
			'Graduated BSc Experimental Psychology (1st class hons.) from the University of Bristol.',
		link: undefined,
		image: undefined,
		disciplines: [d.cmplx],
	},
	...
	},
	{
		...
		description:
			' Digital signage technician (PT) for practices in the Aspen Centre cluster of general medical practices in Gloucestershire',
		link: undefined,
		image: undefined,
		disciplines: [d.web],
	},
	{
		...
		title: 'Web developer',
		description:
			'Webdesigner and webmaster (PT) for Barnwood Medical Practice, Gloucestershire',
		link: undefined,
		image: undefined,
		disciplines: [d.web],
	},
	{
		...
		title: 'Administrator',
		description:
			'Records clerk (PT) for the Portland Surgery, Gloucestershire. Previously Data administrator (PT alongside studies) for Barnwood Medical Practice, Gloucestershire',
		link: undefined,
		image: undefined,
		disciplines: [d.cmplx],
	},
